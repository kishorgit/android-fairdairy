...
import com.example.user.sunaitestingapp.adapter.subsproductlist_adapter;
import com.example.user.sunaitestingapp.adapter.subsproductlist_adapter;
...
public class productsublist_activity extends AppCompatActivity {

    public String TAG = "productsublist_activity";
    TextView currnetdate;
    private RecyclerView recyclerView;
    private subsproductlist_adapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productsublist_activity);
        findViewId();
        ...
        mAdapter = new subsproductlist_adapter(empList,getApplicationContext(), new subsproductlist_adapter.MyAdapterListener() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                globalVariable.product_name=change_schedule_model.getProduct_name();
                globalVariable.pricePerUnit= String.valueOf(change_schedule_model.getPricePerUnit());
                globalVariable.globalsubscriptflag=1;
                Intent intent = new Intent(getApplicationContext(),subscription_activity.class);
                startActivity(intent);
                finish();
            }
    ...
    private void findViewId() {
        ...
        alertDialog = new AlertDialog.Builder(productsublist_activity.this);
        mHandler = new Handler();
        progressDialog = new ProgressDialog(productsublist_activity.this);
    }
    @Override
